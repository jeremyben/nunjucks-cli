...
# -----------------------------------------------------
locals {
  channel           = "boobies"        # Refer - WH standard tagging  documents
  product           = "eks"
  classification    =  # Refer - WH standard tagging  documents
  ...
  costcentre       =       # Refer - WH standard tagging  documents
  owner             =           # Refer - WH standard tagging  documents
  subdivision       = "boobies"        # Refer - WH standard tagging  documents
